...
export function RadioLabel(props: { labelInputData: labelData; labelGroupName: string }) {
  ...
  return (
    <div className={styles.Label} style={{ backgroundColor: bgColor }}>
      <input type="radio" id={`label-${name}-${randomNamePart}`} name={labelGroupName} value={name} onChange={(e: React.FormEvent<HTMLInputElement>) => onToggleHandler()} />
